...
levels = [
    ...
    Level(2, bg_img2, enemy_images, cutscene_func=level1, duration=30000),
    Level(3, bg_img3, enemy_images, cutscene_func=level2, duration= 30000),
]
level = 1
...
while running:
    ...
    if level == 3:
        ...
        if boss_active:
            ...
            boss.update_attack()
            boss.update_bullets(WIDTH, HEIGHT)
