...
car1_img = pygame.transform.scale(pygame.image.load("car1.png").convert_alpha(), (60, 40))
car2_img = pygame.transform.scale(pygame.image.load("car2.png").convert_alpha(), (60, 40))
...
bg_img1 = pygame.transform.scale(pygame.image.load("background1.png").convert(), (WIDTH, HEIGHT))
bg_img2 = pygame.transform.scale(pygame.image.load("background2.png").convert(), (WIDTH, HEIGHT))
