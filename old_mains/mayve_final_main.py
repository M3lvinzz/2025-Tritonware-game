...
levels = [
    Level(1, bg_img1, enemy_images, cutscene_func=None, duration= 100),
    Level(2, bg_img2, enemy_images, cutscene_func=level1, duration = 100),
...
while running:
    ...
    if new_level != level:
        ...
        bg_for_cutscene = (
            bg_img1 if level == 1 else
            bg_img2 if level == 2 else
            bg_img3
        )
